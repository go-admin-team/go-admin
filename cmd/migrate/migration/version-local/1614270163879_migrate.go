...
func init() {
	...
	migration.Migrate.SetVersion(migration.GetFilename(fileName), _1614270163879Test)
}

func _1614270163879Test(db *gorm.DB, version string) error {
	data := []byte(`{
  "86": {
    "110000": "北京市",
    "120000": "天津市",
  ...
  "820000": {
	...
	return db.Transaction(func(tx *gorm.DB) error {
		...
		var list []models.SysChinaAreaData
