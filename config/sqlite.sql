...
CREATE TABLE `sys_operlog` (
  `operId` integer NOT NULL PRIMARY KEY AUTOINCREMENT
...
,  `operUrl` varchar(255) DEFAULT NULL
,  `operIp` varchar(255) DEFAULT NULL
,  `operLocation` varchar(255) DEFAULT NULL
,  `operParam` varchar(2048) DEFAULT NULL
,  `status` varchar(255) DEFAULT NULL
,  `operTime` datetime DEFAULT NULL
,  `jsonResult` varchar(255) DEFAULT NULL
,  `create_by` varchar(255) DEFAULT NULL
,  `create_time` datetime DEFAULT NULL
,  `update_by` varchar(255) DEFAULT NULL
,  `update_time` datetime DEFAULT NULL
...
,  `update_by` varchar(128) DEFAULT NULL
,  `update_time` datetime DEFAULT NULL
,  `is_logical_delete` char(4) DEFAULT NULL
...
INSERT INTO `sys_dict_data` VALUES (30, 0, '退出', '11', 'sys_oper_type', '', '', '', '0', '', '1', '2020-03-15 18:35:39', '', '2020-03-15 18:39:30', '', '', '', '');
INSERT INTO `sys_dict_data` VALUES (31, 0, '获取验证码', '12', 'sys_oper_type', '', '', '', '0', '', '1', '2020-03-15 18:38:42', '', '2020-03-15 18:39:30', '获取验证码', '', '', '');
