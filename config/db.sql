...
values  (5, 'go-admin/app/admin/apis.SysLoginLog.Get-fm', '登陆日志通过id获取', '/api/v1/sys-login-log/:id', 'BUS', 'GET', '2021-05-13 19:59:00.728', '2021-06-13 20:53:47.671', null, 0, 0),
        ...
        (17, 'go-admin/app/other/apis.SysAreaData.GetPage-fm', '行政区列表', '/api/v1/sys-area-data', 'BUS', 'GET', '2021-05-13 19:59:01.342', '2021-06-13 20:53:47.453', null, 0, 0),
        (18, 'go-admin/app/other/apis.SysAreaData.Get-fm', '行政区通过id获取', '/api/v1/sys-area-data/:id', 'BUS', 'GET', '2021-05-13 19:59:01.390', '2021-06-13 20:53:47.497', null, 0, 0),
        ...
        (77, 'go-admin/app/other/apis.SysAreaData.Insert-fm', '行政区创建', '/api/v1/sys-area-data', 'BUS', 'POST', '2021-05-13 19:59:04.210', '2021-06-13 20:53:50.416', null, 0, 0),
        ...
        (98, 'go-admin/app/other/apis.SysAreaData.Update-fm', '行政区编辑', '/api/v1/sys-area-data/:id', 'BUS', 'PUT', '2021-05-13 19:59:05.387', '2021-06-13 20:53:51.120', null, 0, 0),
        ...
        (117, 'go-admin/app/other/apis.SysAreaData.Delete-fm', '行政区删除', '/api/v1/sys-area-data', 'BUS', 'DELETE', '2021-05-13 19:59:06.249', '2021-06-13 20:53:52.061', null, 0, 0),
...
values  (2, 'Admin', '系统管理', 'api-server', '/admin', '/0/2', 'M', '无', '', 0, 1, '', 'Layout', 10, '0', '1', 0, 1, '2021-05-20 21:58:45.679', '2021-06-12 23:53:56.276', null),
        ...
        (538, 'SysAreaData', '行政区管理', 'nested', '/sys-tools/sys-china-area-data', '', 'C', '', 'sysTools:SysAreaData:list', 537, 0, '', '/sys-tools/sys-china-area-data/index', 0, '0', '1', 1, 1, '2021-05-21 11:18:50.712', '2021-06-05 22:15:03.465', null),
