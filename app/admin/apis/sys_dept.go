...
func (e SysDept) GetSysDept(c *gin.Context) {
	...
	err = s.GetSysDept(control, &object)
	if err != nil {
		e.Error(http.StatusUnprocessableEntity, err, "查询失败")
		return
	}
